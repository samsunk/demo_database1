    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `Person` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `fname` TEXT NOT NULL, `add` TEXT NOT NULL, `contact` TEXT NOT NULL, `age` INTEGER NOT NULL)');
